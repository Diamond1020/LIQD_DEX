             ...
             */}
                ...
                <CardBody>
                    <Container>
                         ...
                         <CopyToClipboard text={`https://dex.liqdex.io/?ref=${rot13(account)}`} onCopy={()=> {handleClick()}}>
                            <Button variant="primary" mt="8px">Copy</Button>
                        </CopyToClipboard>
                    </Container>
                </CardBody>
                <StyledFooter >
                    ...
                    <StyledLink style={{"margin":"auto"}}>{`https://dex.liqdex.io/?ref=${rot13(account)}`}</StyledLink>
                </StyledFooter>
